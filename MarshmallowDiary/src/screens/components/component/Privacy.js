    ...
    return (
        <SafeAreaView>
          ...
          <View style={{ flexDirection:'row', marginTop:'15%'}}>
            <Text style={{textAlign:'center', fontSize:18}}>4</Text>
            <Text style={{textAlign:'center', fontSize:18}}>5</Text>
            <Text style={{textAlign:'center', fontSize:18}}>6</Text>
          </View>
          <View style={{ flexDirection:'row', marginTop:'15%'}}>
            <Text style={{textAlign:'center', fontSize:18}}>7</Text>
            <Text style={{textAlign:'center', fontSize:18}}>8</Text>
            <Text style={{textAlign:'center', fontSize:18}}>9</Text>
          </View>
          <View style={{ flexDirection:'row', marginTop:'15%' }}>
            <Text style={{textAlign:'center', fontSize:18}}>지우기</Text>
            <Text style={{textAlign:'center', fontSize:18}}>0</Text>
            <Text style={{textAlign:'center', fontSize:18}}>취소</Text>
          </View>
