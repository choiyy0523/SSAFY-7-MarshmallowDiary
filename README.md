...
| ---- | ------ | ----------------------------------------------- | --------------------------------- |
| 팀장 | 최윤영 | `FE` 다이어리 작성/조회/분석/추천, 환경설정     | 발표(중간), PPT(중간), README     |
| 팀원 | 김현지 | `BE` 다이어리 작성/조회, 검색                   | UCC, 포팅매뉴얼                   |
| 팀원 | 박현영 | `BE` 회원가입/로그인, 회원 정보 관리            | UCC, 포팅매뉴얼                   |
| 팀원 | 유지슬 | `BE` 다이어리 분석 및 결과 조회                 | 발표(최종), PPT(최종), 포팅매뉴얼 |
| 팀원 | 이도연 | `BE` 서버 배포 및 테스트 코드 작성              | PPT(최종), 포팅매뉴얼             |
| 팀원 | 전상현 | `FE` 회원가입/로그인, 메인화면, 분석/통계, 검색 | README                            |
